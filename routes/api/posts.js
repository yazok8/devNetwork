...
//@route   Post api/posts: create a post. private access
router.post(
  '/',
...
router.put('/like/:id', auth, async (req, res) => {
  try {
    ...
    if (post.likes.some((like) => like.user.toString() === req.user.id) > 0) {
...
//@route   Post api/posts/comment/:id: comment on a post. private access
router.post(
  '/comment/:id',
  [auth, [check('text', 'Text is required').not().isEmpty()]],
  async (req, res) => {
...
//@route   Post api/posts/comment/:id/comment_id: comment on a post. private access
